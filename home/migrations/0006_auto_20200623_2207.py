...
def migrate_walks(apps, schema_editor):
    with schema_editor.connection.cursor() as cursor:
        ...
        cursor.execute("""
            ...
            FROM (
                SELECT dev.device_id device_id, dev.account_id account_id, au.account_id appuser_id
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='device',
            name='account',
            field=models.ForeignKey(help_text='User account associated with this registered device', on_delete=django.db.models.deletion.CASCADE, to='home.Account'),
        ),
        migrations.RunPython(migrate_appusers, reverse_code=migrations.RunPython.noop),
        migrations.AddField(
            model_name='account',
            name='contests',
        ...
        migrations.AddField(
            ...
            name='account',
            field=models.ForeignKey(default=0, help_text='Account the data is linked to', on_delete=django.db.models.deletion.CASCADE, to='home.Account'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='dailywalk',
            name='device',
            field=models.ForeignKey(default="0", help_text='Device the data is coming from', on_delete=django.db.models.deletion.CASCADE, to='home.Device'),
            preserve_default=False,
        ),
        migrations.AddField(
        ...
        migrations.RunPython(migrate_walks, reverse_code=migrations.RunPython.noop),
        ...
        migrations.AddField(
            model_name='contest',
            name='created',
            field=models.DateTimeField(auto_now_add=True, default=django.utils.timezone.now, help_text='Contest creation timestamp'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='contest',
            name='updated',
            field=models.DateTimeField(auto_now=True, help_text='Contest updation timestamp'),
        ),
        migrations.AlterField(
            model_name='contest',
            name='contest_id',
            field=models.CharField(default=uuid.uuid4, help_text='Contest identifier', max_length=250, primary_key=True, serialize=False),
        ),
        migrations.AlterField(
            model_name='contest',
            name='end',
        ...
        migrations.AlterField(
            model_name='dailywalk',
            name='date',
            field=models.DateField(help_text='The specific for which the steps are recorded for'),
        ),
        migrations.AlterField(
            model_name='dailywalk',
            name='distance',
        ...
        migrations.AlterField(
            model_name='dailywalk',
            name='updated',
            field=models.DateTimeField(auto_now=True, help_text='Record updation timestamp'),
        ),
        migrations.AlterField(
            model_name='intentionalwalk',
            name='created',
        ...
        migrations.AlterField(
            model_name='intentionalwalk',
            name='end',
            field=models.DateTimeField(help_text='Timestamp when the intentional walk ended'),
        ),
        migrations.AlterField(
            model_name='intentionalwalk',
            name='pause_time',
            field=models.FloatField(help_text='Total time paused (in seconds)'),
        ),
        migrations.AlterField(
            model_name='intentionalwalk',
            name='start',
            field=models.DateTimeField(help_text='Timestamp when the intentional walk started'),
        ),
        migrations.AlterField(
            model_name='intentionalwalk',
            name='steps',
