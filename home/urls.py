...
urlpatterns = [
    ...
    path("data/users_agg.csv", views.user_agg_csv_view, name="users_agg_csv_view"),
    path("data/users.csv", views.users_csv_view, name="users_csv_view"),
    path("data/daily_walks.csv", views.daily_walks_csv_view, name="dailywalks_csv_view"),
    path("data/intentional_walks.csv", views.intentional_walks_csv_view, name="intentionalwalks_csv_view"),
    path("api/appuser/create", views.AppUserCreateView.as_view(), name="appuser_create"),
    path("api/appuser/delete", views.AppUserDeleteView.as_view(), name="appuser_delete"),
